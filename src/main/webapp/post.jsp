				...
				<div class="col-md-8">
					<article class="blog-post">
						<div class="blog-post-image">
							<a href="post.jsp"><img src="images/750x500-5.jpg" alt=""></a>
						</div>
						<div class="blog-post-body">
							<h2><a href="post.jsp">Vintage-Inspired Finds for Your Home</a></h2>
				...
				<div class="col-md-4 sidebar-gutter">
					...
					<div class="sidebar-widget">
						...
						<div class="widget-container widget-about">
							<a href="post.jsp"><img src="images/author.jpg" alt=""></a>
							<h4>Jamie Mooz</h4>
						...
						<div class="widget-container">
							<article class="widget-post">
								<div class="post-image">
									<a href="post.jsp"><img src="images/90x60-1.jpg" alt=""></a>
								</div>
								<div class="post-body">
									<h2><a href="post.jsp">The State of the Word 2014</a></h2>
									<div class="post-meta">
										<span><i class="fa fa-clock-o"></i> 2. august 2015</span> <span><a href="post.jsp"><i class="fa fa-comment-o"></i> 23</a></span>
									</div>
								</div>
							</article>
							<article class="widget-post">
								<div class="post-image">
									<a href="post.jsp"><img src="images/90x60-2.jpg" alt=""></a>
								</div>
								<div class="post-body">
									<h2><a href="post.jsp">Why The Muppets Needs to Channel 30 Rock</a></h2>
									<div class="post-meta">
										<span><i class="fa fa-clock-o"></i> 2. august 2015</span> <span><a href="post.jsp"><i class="fa fa-comment-o"></i> 23</a></span>
									</div>
								</div>
							...
							<article class="widget-post">
								<div class="post-image">
									<a href="post.jsp"><img src="images/90x60-3.jpg" alt=""></a>
								</div>
								<div class="post-body">
									<h2><a href="post.jsp">The State of the Word 2014</a></h2>
									<div class="post-meta">
							...
							<article class="widget-post">
								<div class="post-image">
									<a href="post.jsp"><img src="images/90x60-4.jpg" alt=""></a>
								</div>
								<div class="post-body">
									<h2><a href="post.jsp">Vintage-Inspired Finds for Your Home</a></h2>
									<div class="post-meta">
							...
							<article class="widget-post">
								<div class="post-image">
									<a href="post.jsp"><img src="images/90x60-5.jpg" alt=""></a>
								</div>
								<div class="post-body">
									<h2><a href="post.jsp">The State of the Word 2014</a></h2>
									<div class="post-meta">
